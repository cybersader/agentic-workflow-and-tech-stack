...
- [`02-stack/02-terminal/index.md`](../../../02-stack/02-terminal/index.md) — the current stack-level terminal page (Zellij / tmux / Portagenty picks + tradeoffs table)
- [`02-stack/patterns/cross-device-ssh.md`](../../../02-stack/patterns/cross-device-ssh.md) — adjacent pattern
