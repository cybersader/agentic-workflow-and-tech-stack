...
| Dimension | [02 · Fragmentation](../../../research/zz-challenges/02-claude-code-conversation-fragmentation.md) | This bug (stale index) |
|---|---|---|
...
- **Stack pattern (tier 2, the discoverable how-to):** [02-stack/patterns/claude-code-session-recovery.md](../../../02-stack/patterns/claude-code-session-recovery.md) — decision tree for picking among `claude -r <uuid>` / `pconv rebuild-index` / `pconv doctor --dump-stale`.
- **Research learning (the insight-archive entry):** [research/learnings/2026-04-23-stale-sessions-index-detection-and-recovery.md](../../../research/learnings/2026-04-23-stale-sessions-index-detection-and-recovery.md) — why the detect + recover-via-extractor pattern generalizes to any append-only-log-plus-summary-index architecture.
- **Upstream comment (the slow-path fix):** [drafted at 2026-04-23-upstream-comment-25032.md](./2026-04-23-upstream-comment-25032.md), posted at [#25032 comment 4304663073](https://github.com/anthropics/claude-code/issues/25032#issuecomment-4304663073).
