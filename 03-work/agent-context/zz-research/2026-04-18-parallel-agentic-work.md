...
- [Parallel Agent Coordination — Findings from the Fan-Out Research Pass](./2026-04-25-parallel-agent-coordination-findings.md) — the deeper-pass output that answers the open questions stamped here
- [ROADMAP Phase 4](../../../../ROADMAP.md) — where `parallel-agents-worktrees.md` gets authored
- [ROADMAP Phase 9](../../../../ROADMAP.md) — the deeper research session
...
- [Post-Filesystem Federated Knowledge](./2026-04-18-post-filesystem-federated-knowledge.md) — at scale, multi-agent coordination eventually bumps into the same "filesystem is primitive" limits
