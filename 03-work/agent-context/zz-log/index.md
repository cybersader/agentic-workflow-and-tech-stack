...
The third surface in `agent-context/`, alongside [zz-research](../zz-research/) (investigations + findings) and [zz-inbox](../zz-inbox/) (unprocessed ideas). This one captures **what shipped today and why** — a chronological trail that's faster to scan than reading every commit message but more durable than memory.
...
- [`zz-research/`](../zz-research/) — investigations + findings (deeper than logs)
- [`zz-inbox/`](../zz-inbox/) — raw idea capture (lower-friction than logs)
