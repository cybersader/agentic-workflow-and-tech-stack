...
<!-- 
  ...
  When a bullet gets its own file, replace with:
    - YYYY-MM-DD: <short label> → [zz-inbox/YYYY-MM-DD-topic.md](./YYYY-MM-DD-topic.md)
-->

- 2026-04-25: `claude -r <uuid>` is cwd-strict — sharpens portaconv's wedge → [2026-04-25-claude-r-cwd-strict-vs-portaconv-wedge.md](./2026-04-25-claude-r-cwd-strict-vs-portaconv-wedge.md). Tier-2 substrate bug (upstream [#5768](https://github.com/anthropics/claude-code/issues/5768) open). Empirically reproduced; portaconv's docs updated to name the bug + add "When `claude -r` is enough" section.
