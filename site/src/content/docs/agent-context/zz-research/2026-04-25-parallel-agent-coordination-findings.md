...
- [Challenge 03 — Parallel Agent Coordination](/agentic-workflow-and-tech-stack/research/zz-challenges/03-parallel-agent-coordination/) — the investigation questions this note answers
- [2026-04-18 — Parallel Agentic Work (pre-challenge stamp)](/agentic-workflow-and-tech-stack/agent-context/zz-research/2026-04-18-parallel-agentic-work/) — the known-primitives baseline
- [`examples/git-worktrees/README.md`](/agentic-workflow-and-tech-stack/examples/git-worktrees/README/) — substrate pattern
- [`.claude/skills/inter-agent-messaging/SKILL.md`](/agentic-workflow-and-tech-stack/.claude/skills/inter-agent-messaging/SKILL/) — existing messaging primitive
- [2025-12-31 learning — inter-agent messaging](/agentic-workflow-and-tech-stack/research/learnings/2025-12-31-inter-agent-messaging/) — deeper messaging context
