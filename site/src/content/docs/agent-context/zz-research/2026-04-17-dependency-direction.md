...
```markdown
❌ See [`../../02-stack/patterns/obsidian-workflow.md`](/agentic-workflow-and-tech-stack/stack/patterns/obsidian-workflow/)
...
- [Meta / Self-Reference principle (09)](/agentic-workflow-and-tech-stack/principles/09-meta-self-reference/) — the kernel/vault/meta separation rationale this extends
- [Five Strata of Repeatability (07)](/agentic-workflow-and-tech-stack/principles/07-five-strata/) — the stratum framework
- [ROADMAP — Phase 8](/agentic-workflow-and-tech-stack/kernel/roadmap/) — extraction phase
