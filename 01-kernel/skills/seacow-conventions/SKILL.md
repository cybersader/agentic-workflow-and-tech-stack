...
title: "SEACOW Meta-Framework: Analytical Lens for Organization"
stratum: 2
branches: [agentic]
---
...
## House conventions (this stack's instantiation)

Relocated from CLAUDE.md (2026-07-10 slim-down) — example conventions, not requirements.

### Tags (ASCII-sort prefixes)
...
### Frontmatter with named SEACOW links
