...
- [Retrieval concepts: from grep to knowledge graphs](./retrieval-concepts-from-grep-to-knowledge-graphs.md) — first-principles guide to lexical, semantic, structural, and temporal retrieval.
- [Vault knowledge engine architecture](./vault-knowledge-engine-architecture.md) — layered, rebuildable architecture with markdown as the sole durable source of truth.
- [Vault search and memory landscape — July 2026](./vault-search-and-memory-landscape-2026-07.md) — dated tool landscape evaluated against the delete-and-rebuild filter.
