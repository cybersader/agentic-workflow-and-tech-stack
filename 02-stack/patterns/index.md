...
| [Delegation Flight Recorder](./delegation-flight-recorder/) | Crash-resilient per-worker checkpoints and automatic tool trails for recovering interrupted Agent and Workflow work, then deleting transient detail after verified synthesis |
