...
For the deeper why, including the receipts: see [`02-stack/05-homelab/self-hosted-paas-truenas-conflict.md`](../05-homelab/self-hosted-paas-truenas-conflict.md). For the broader PaaS landscape: [`02-stack/05-homelab/self-hosted-deployment-platforms.md`](../05-homelab/self-hosted-deployment-platforms.md).
...
- [`02-stack/05-homelab/self-hosted-paas-truenas-conflict.md`](../05-homelab/self-hosted-paas-truenas-conflict.md) — the why (TrueNAS / PaaS Docker conflict)
- [`02-stack/05-homelab/self-hosted-deployment-platforms.md`](../05-homelab/self-hosted-deployment-platforms.md) — the broader landscape (why Dokploy over Coolify/CapRover/Dokku)
